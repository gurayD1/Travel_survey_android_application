...
public class CityDB implements Serializable {
    ...
    public CityDB() {
        ...
        AddCity(new CityModel("La Romana", "Dominican Republic",
                ...
                "Rich", "Crowds",
                "Urban",
                "https://www.godominicanrepublic.com/la-romana/", "city_santodomingo"));
        ...
        AddCity(new CityModel("White House", "Jamaica",
                ...
                "Mid", "Wild Animals",
                "Beach", "https://www.sandals.com/south-coast/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Santa Clara", "Cuba",
                ...
                "Cheap",
                "Wild Animals",
                "Rural", "https://www.tripcuba.org/santa-clara-villa-clara", "city_santodomingo"));
        AddCity(new CityModel("Centro Habana", "Cuba",
                ...
                "Mid",
                "Crowds",
                "Urban", "https://www.tripcuba.org/centro-habana", "city_santodomingo"));
        ...
        AddCity(new CityModel("Delhi", "India",
                ...
                "Crowds",
                "Urban",
                "https://www.delhitourism.gov.in/delhitourism/aboutus/index.jsp", "city_santodomingo"));
        AddCity(new CityModel("Jaipur", "India",
                ...
                "Rich",
                "Bugs",
                "Urban", "https://www.jaipurtravel.com/", "city_santodomingo"));
        AddCity(new CityModel("Agra", "India",
                ...
                "Cheap",
                "Bugs",
                "Urban", "https://agra.nic.in/tourism/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Cancun", "Mexico",
                ...
                "Cheap",
                "Bugs",
                "Beach", "https://www.mexicancaribbean.travel/cancun/", "city_santodomingo"));
        AddCity(new CityModel("Mexico City", "Mexico",
                ...
                "Mid",
                "Crowds",
                "Urban", "https://www.visitmexico.com/en/mexico-city", "city_santodomingo"));
        AddCity(new CityModel("San Cristóbal De Las Casas", "Mexico",
                ...
                "Wild Animals",
                "Rural",
                "https://www.visitmexico.com/en/chiapas/san-cristobal-de-las-casas", "city_santodomingo"));
        ...
        AddCity(new CityModel("Istanbul", "Turkey",
                ...
                "Cheap", "None",
                "Urban", "https://visit.istanbul/en/", "city_santodomingo"));
        AddCity(new CityModel("Izmir", "Turkey",
                ...
                "Cheap", "None",
                "Beach", "https://www.visitizmir.org/en", "city_santodomingo"));
        ...
        AddCity(new CityModel("Paris", "France",
                ...
                "Mid", "None",
                "Urban", "https://www.visitparisregion.com/en", "city_santodomingo"));
        AddCity(new CityModel("Nice", "France",
                ...
                "Cheap", "None",
                "Beach", "http://www.nice-tourism.com/en/", "city_santodomingo"));
        AddCity(new CityModel("Lyon", "France",
                ...
                "Cheap", "None",
                "Urban", "https://en.lyon-france.com/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Rome", "Italy",
                ...
                "Mid", "Crowds",
                "Urban", "https://romesite.com/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Florence", "Italy",
                ...
                "Cheap", "Crowds",
                "Urban", "https://www.visitflorence.com/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Lisbon", "Portugal",
                ...
                "Cheap", "Crowds",
                "Urban", "https://lisbonlisboaportugal.com/index.html", "city_santodomingo"));
        AddCity(new CityModel("Porto", "Portugal",
                ...
                "Cheap", "None",
                "Beach", "https://www.introducingporto.com/", "city_santodomingo"));
        AddCity(new CityModel("Albufeira", "Portugal",
                ...
                "Cheap", "Bugs",
                "Beach", "https://albufeira.com/", "city_santodomingo"));
        ...
        AddCity(new CityModel("London", "England",
                ...
                "Mid", "Crowds",
                "Urban", "https://www.visitlondon.com/", "city_santodomingo"));
        AddCity(new CityModel("Oxford", "England",
                ...
                "Cheap", "Crowds",
                "Urban", "https://www.tourismoxford.ca/", "city_santodomingo"));
        AddCity(new CityModel("Canterbury", "England",
                ...
                "Mid", "None",
                "Rural", "https://www.canterbury.co.uk/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Toronto", "Canada",
                ...
                "Mid", "None",
                "Urban", "https://www.destinationtoronto.com/", "city_santodomingo"));
        AddCity(new CityModel("Ottawa", "Canada",
                ...
                "Mid", "None",
                "Urban", "https://ottawatourism.ca/en", "city_santodomingo"));
        AddCity(new CityModel("Quebec City", "Canada",
                ...
                "Cheap", "None",
                "Urban", "https://www.quebec-cite.com/en", "city_santodomingo"));
        ...
        AddCity(new CityModel("Oslo", "Norway",
                ...
                "Mid", "None",
                "Urban", "https://www.visitoslo.com/en/", "city_santodomingo"));
        AddCity(new CityModel("Bergen", "Norway",
                ...
                "Cheap", "None",
                "Beach", "https://en.visitbergen.com/", "city_santodomingo"));
        AddCity(new CityModel("Ålesund", "Norway",
                ...
                "Cheap", "None",
                "Urban",
                "https://www.fjordtours.com/places-to-visit-in-norway/alesund/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Reykjavík", "Iceland",
                ...
                "Rich", "None",
                "Urban", "https://www.visiticeland.com/article/reykjavik/", "city_santodomingo"));
        ...
        AddCity(new CityModel("Akureyri", "Iceland",
                ...
                "Mid", "None",
                "Rural", "https://www.visitakureyri.is/en", "city_santodomingo"));
        ...
        AddCity(new CityModel("Zurich", "Switzerland",
                ...
                "Mid", "Crowds",
                "Urban", "https://www.zuerich.com/en", "city_santodomingo"));
        AddCity(new CityModel("Geneva", "Switzerland",
                ...
                "Mid", "Crowds",
                "Urban", "http://www.geneva.info/sights/", "city_santodomingo"));
        AddCity(new CityModel("Bern", "Switzerland",
                ...
                "Mid", "None",
                "Rural", "https://www.bern.com/en/home", "city_santodomingo"));
        ...
        AddCity(new CityModel("Mohe City", "China",
                ...
                "Cheap", "Wild Animals",
                "Rural", "https://www.chinatravel.com/mohe", "city_santodomingo"));
        AddCity(new CityModel("Harbin", "China",
                ...
                "Cheap", "Crowds",
                "Urban", "http://www.harbin.gov.cn/col/col16590/index.html", "city_santodomingo"));
        AddCity(new CityModel("Yunnan", "China",
                ...
                "Cheap", "Bugs",
                "Rural", "https://ancientyunnan.com/", "city_santodomingo"));
    }
